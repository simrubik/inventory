...
<body>
	...
	<div class="row">		
		<div class="col-xs-8">
			<form:form action="employees" method="POST">
					<div class="col-xs-8 input-group">
						<input type="text" class="form-control" placeholder="Search..." name="employeeName" /> 
		...
		<div class="col-xs-4">
			<a class="btn icon-btn btn-success pull-right" href="<c:url value="employees/new" />" >
	...
	<div>
			<table id="employeeSearch" class="table table-bordered table-striped" style="width: 100%">
				<thead>
					<tr>
						<th>First Name</th>
						<th>Second Name</th>
